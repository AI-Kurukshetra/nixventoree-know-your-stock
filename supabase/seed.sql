...
values
  ...
  ('00000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000004', '40000000-0000-0000-0000-000000000003', 'adjustment', 4, 'Bundle assembly', now() - interval '58 minutes');insert into public.purchase_order_items (id, organization_id, purchase_order_id, variant_id, quantity, unit_cost, received_quantity)`r`nvalues`r`n  ('92000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '90000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', 240, 6.40, 0),`r`n  ('92000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', '90000000-0000-0000-0000-000000000002', '60000000-0000-0000-0000-000000000003', 140, 12.50, 60)`r`non conflict (id) do nothing;
