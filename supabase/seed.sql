...
insert into public.purchase_order_items (id, organization_id, purchase_order_id, variant_id, quantity, unit_cost, received_quantity)
values
  ('92000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '90000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', 240, 6.40, 0),
  ('92000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', '90000000-0000-0000-0000-000000000002', '60000000-0000-0000-0000-000000000003', 140, 12.50, 60)
on conflict (id) do nothing;
